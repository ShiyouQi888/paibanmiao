...
<p align="center">
  <a href="https://paibanmiao.com">🌐 官网</a> •
  <a href="https://edit.paibanmiao.com">✏️ 在线使用</a> •
  <a href="https://paibanmiao.com/docs">📖 文档</a> •
  <a href="https://github.com/tenngoxars/paibanmiao/releases">📦 下载桌面版</a>
</p>
...
排版喵 内置了一套**色彩语义保全算法**，可在编辑器中预览微信公众号深色模式下的实际效果，还原度达 **98% 以上**。
...
👉 **[查看算法详细原理解析](https://paibanmiao.com/docs/reference/dark-mode-algorithm.html)** | **[查看算法源码](packages/core/src/wechatDarkMode.ts)**
...
直接访问 **[edit.paibanmiao.com](https://edit.paibanmiao.com)** 即可开始写作，无需安装，同样支持纯本地存储。

### 桌面版下载

前往 [Releases](https://github.com/tenngoxars/paibanmiao/releases) 下载对应平台安装包：
...
>
> ```bash
> xattr -cr /Applications/paibanmiao.app
> ```
>
> ⚠️ **Windows 用户注意**：如 SmartScreen 提示"未知发布者"，点击「更多信息」→「仍要运行」
>
> ⚠️ **Linux 用户注意**：运行前需设置可执行权限：`chmod +x paibanmiao.AppImage`
...
```bash
# 构建 Web
pnpm --filter @paibanmiao/web build

# 构建桌面应用
pnpm --filter paibanmiao-electron run build:mac  # macOS
pnpm --filter paibanmiao-electron run build:win  # Windows
```
...
如有问题或建议，欢迎提交 [Issue](https://github.com/tenngoxars/paibanmiao/issues)。
