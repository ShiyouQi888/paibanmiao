...
app.setName('排版喵');
app.setAppUserModelId('com.paibanmiao.app');
...
function createWindow() {
    ...
    console.log('[排版喵] Loading URL:', startUrl);
    console.log('[排版喵] isDev:', isDev);
    console.log('[排版喵] resourcesPath:', process.resourcesPath);
    ...
    const template: Electron.MenuItemConstructorOptions[] = [
        {
            label: '排版喵',
            submenu: [
                { role: 'about', label: '关于 排版喵' },
                { type: 'separator' },
                { role: 'hide', label: '隐藏 排版喵' },
                { role: 'hideOthers', label: '隐藏其他' },
                { role: 'unhide', label: '显示全部' },
                { type: 'separator' },
                { role: 'quit', label: '退出 排版喵' },
            ],
        },
        {
            label: '文件',
        ...
        },
        {
            ...
            submenu: [
                ...
                {
                    label: '访问官网',
                    click: () => shell.openExternal('https://paibanmiao.com'),
                },
                {
                    label: 'GitHub 仓库',
                    click: () => shell.openExternal('https://github.com/tenngoxars/paibanmiao'),
                },
            ],
        },
    ];
