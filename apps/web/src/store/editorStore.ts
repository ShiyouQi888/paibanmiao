...
export const defaultMarkdown = `# 欢迎使用排版喵
...
这是一个 [链接](https://github.com/idootop/paibanmiao)
...
## 7. 脚注与链接建议
这里演示脚注的使用：[排版喵](https://github.com/idootop/paibanmiao "排版喵 是一款专为公众号设计的编辑器") 可以极大提升排版效率。

在排版喵 中，只需为链接添加“标题”（双引号里的文字），系统就会自动将其转换为文末脚注，这是最符合微信公众号习惯的排法。
...
## 9. 图片
![排版喵：专为微信公众号设计的现代化 Markdown 编辑器](https://img.paibanmiao.app/example.jpg)
