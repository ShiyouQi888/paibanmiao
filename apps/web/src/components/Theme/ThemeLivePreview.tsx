...
这是一段**加粗文本**、*斜体文本*、~~删除线文本~~、==高亮文本==和 [链接示例](https://github.com/tenngoxars/paibanmiao)。
...
这里演示脚注的使用：[WeChat Markdown](https://github.com/tenngoxars/paibanmiao "排版喵 是一款专为公众号设计的编辑器") 可以极大提升排版效率。
...
这里有 \`行内代码\` 样式，也可以用来表示 \`npm install paibanmiao\` 等指令。
...
![排版喵 示例图片：不仅支持常规排版，更可以深度定制每一个细节。](https://img.paibanmiao.app/example.jpg)
`;
